...
func (vimagination_zapto_org_cache_lru[T, U]) Remove(_ **vimagination_zapto_org_cache_item[T, U], _ **vimagination_zapto_org_cache_item[T, U]) (_ *vimagination_zapto_org_cache_item[T, U]) {
	return
}
